...
import os
from HyperFree.utils.spectral_process_utils import write_img
import cv2
...
def hyperspectral_classification(mask_generator, image, few_shots, spectral_lengths, feature_index_id, GSD, open_set_thresh = 0):
    """
